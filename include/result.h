...
typedef struct {
	enum {
		...
		ERR_SEMA_LINKAGE_EXTERNAL_REDEFINED_NONE,
		ERR_SEMA_LINKAGE_NONE_REDEFINED_EXTERNAL,
		ERR_SEMA_NESTED_FUNCTION_DEFINITION,
		ERR_SEMA_DUPLICATE_FUNCTION_DEFINITION,
		ERR_SEMA_DUPLICATE_FUNCTION_PARAMETER,
		ERR_SEMA_UNDECLARED_FUNCTION_CALL,
		ERR_SEMA_TYPECHECK_FUNCTION_CALL_ARGUMENTS,
		ERR_SEMA_TYPECHECK_VARIABLE_AS_CALLABLE,
		ERR_SEMA_DUPLICATE_VARIABLE_DECLARATION,
		ERR_SEMA_UNDECLARED_VARIABLE_USAGE,
		ERR_SEMA_DECL_INVALID_LVALUE,
		ERR_SEMA_DECL_INVALID_LVALUE_SYM_FUNC,
		ERR_SEMA_DECL_INVALID_RVALUE_SYM_FUNC,
